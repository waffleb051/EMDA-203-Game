...
(function (window, document, undefined) {
    ...
    function actuallyAddCollider(sprite, spriteInfo, hitBoxRatio) {
        ...
        if (hitBoxRatio < 0.2)
            hitBoxRatio = 0.2; //make sure they don't accidentally make tiny or enormous colliders
        if (hitBoxRatio > 5.0)
            hitBoxRatio = 5.0;
        ...
        sprite.collidesWith = function (other) {
            ...
            if (COLLISION_GNOME_DEBUG) {
                ...
                if (!sprite.debox) {
                    ...
                    sprite.debox.graphics.drawRect(0, 0, sprite.xDist * 2, sprite.yDist * 2);
                }
                sprite.debox.x = sprite.x - sprite.xDist;
                sprite.debox.y = sprite.y - sprite.yDist;
                if (!sprite.addedDebox) {
                    myStage.addChild(sprite.debox);
